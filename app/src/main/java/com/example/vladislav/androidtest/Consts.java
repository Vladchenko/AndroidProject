...
public class Consts {
    ...
    public static final String GOOGLE_MAPS_URI = "google.streetview:cbll=46.414382,10.013988";
    public static final String GOOGLE_MAPS_PACKAGE = "com.google.android.apps.maps";
    public static final String BANK_DEPARTMENT_ESTIMATION_MESSAGE =
    "Estimate the performance of a current bank department, please.";
